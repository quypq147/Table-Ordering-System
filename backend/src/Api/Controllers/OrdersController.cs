...
public class OrdersController : ControllerBase
{
    ...
    [HttpGet]
    public async Task<ActionResult<IReadOnlyList<OrderDto>>> ListByTable([FromQuery] string tableId, [FromQuery] int page = 1, [FromQuery] int pageSize = 20)
    ...
    public sealed record StartDto(string OrderId, string TableId);
    [HttpPost("start")]
    ...
    [HttpPost("{id}/submit")]
    public async Task<ActionResult<OrderDto>> Submit(string id)
    ...
    [HttpPost("{id}/pay")]
    public async Task<ActionResult<OrderDto>> Pay(string id, [FromBody] PayDto body)
    ...
    public sealed record AddItemDto(string MenuItemId, string Name, decimal Price, string Currency, int Quantity);
    [HttpPost("{id}/items")]
    public async Task<ActionResult<OrderDto>> AddItem(string id, [FromBody] AddItemDto body)
    ...
    public async Task<ActionResult<OrderDto>> ChangeItemQuantity(string id, int orderItemId, [FromBody] ChangeQtyDto body)
    ...
    public sealed record RemoveItemDto(string MenuItemId);
    [HttpDelete("{id}/items")]
    public async Task<ActionResult<OrderDto>> RemoveItem(string id, [FromBody] RemoveItemDto body)
