...
public class BackendApiClient
{
    ...
    // KDS
    public async Task<List<KitchenTicketDto>> GetTicketsAsync(Guid stationId)
        => await _http.GetFromJsonAsync<List<KitchenTicketDto>>($"/api/kds/tickets?stationId={stationId}") ?? [];
}
